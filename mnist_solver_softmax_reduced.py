"""
Everything is same as `mnist_solver_softmax.py`, it is just that i tried simplication of cost function
derivative and wrote simplication at line 78 and 79

Thus unneeding to do bunch of matrix multiplication
"""
import pickle
    ...
    def train(self, train_data: dict, epoch: int, learn_rate: float, batch_num: int):
        ...
        for ep in range(epoch):
            ...
            for x, y in batches:
                ...
                sub = diff - np.sum(diff * activations[-1], axis=0)
                delta = sub * activations[-1]
